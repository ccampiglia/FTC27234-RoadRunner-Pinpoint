...
public class AutoVariables {
    ...
    public static final int ARM_COLLECT_SPECIMEN = 21 * ARM_TICKS_PER_DEGREE;
    public static final int ARM_SCORE_SPECIMEN = 50 * ARM_TICKS_PER_DEGREE;
    public static final int ARM_ATTACH_SPECIMEN = 35 * ARM_TICKS_PER_DEGREE;
    ...
    public static final double WRIST_FOLDED_IN = 0.35;
    public static final double WRIST_COLLECT_SPECIMEN = 0.9;
    public static final double WRIST_SCORE_SPECIMEN = 0.9;
    public static final double WRIST_HANG_SPECIMEN = 0.5;
