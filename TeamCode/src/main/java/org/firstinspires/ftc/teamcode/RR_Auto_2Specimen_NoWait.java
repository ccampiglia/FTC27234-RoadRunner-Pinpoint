...
@Autonomous(name = "RR_Auto_2Specimen_NoWait", preselectTeleOp = "TeleopClaw_V5_Dual_Control_MAIN")
public class RR_Auto_2Specimen_NoWait extends LinearOpMode {
        ...
        if (opModeIsActive()) {
            ...
            Actions.runBlocking(
                    drive.actionBuilder(initialPose)
                            ...
                            .strafeToLinearHeading(new Vector2d(52, -44), Math.toRadians(-90.00), new TranslationalVelConstraint(velocityOverride))
