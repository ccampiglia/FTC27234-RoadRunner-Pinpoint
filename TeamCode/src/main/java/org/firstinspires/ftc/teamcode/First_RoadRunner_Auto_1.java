...
@Autonomous(name = "First_RoadRunner_Auto_1", preselectTeleOp = "Teleop_V4_Dual_Control_Main")
public class First_RoadRunner_Auto_1 extends LinearOpMode {
    ...
    public class ClawMode implements Action {
        Servo claw;
        double clawPosition;

        public ClawMode(Servo s, double p) {
            this.claw = s;
            this.clawPosition = p;
        }
